      ...
      <View>
        <View style={styles.header}>
          <View style={styles.locationHeader}>
            ...
            <Text style={styles.locationText}>SnakTime</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  carouselContainer: {
    position: "absolute",
    bottom: 0,                  // keep it inside the screen
    left: 0,
    right: 0,
    height: 240,                // shrink a bit so it fits above tabs
    paddingBottom: Platform.OS === "ios" ? 24 : 12, // add breathing room
  },
  carousel: {
