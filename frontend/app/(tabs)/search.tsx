...
export default function SearchScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cuisineScrollWrapper}>
  <ScrollView
    horizontal
  ...
  >
        {cuisines.map((cuisine) => (
          ...
          >
            <Text
  allowFontScaling={false}  // ⬅️ disables system-wide font scaling
  style={[
    styles.cuisineText,
...
const styles = StyleSheet.create({
  ...
  paddingTop: 12,
  paddingBottom: 0, // ✅ tighten it up
  gap: 8,
},

cuisineButton: {
  paddingHorizontal: 14,
  paddingVertical: 12, // 🔽 reduce this to control height
  borderRadius: 16,
...
cuisineText: {
  fontSize: 13,               // ⬅️ make it smaller
  fontWeight: "500",
  color: Colors.text.primary,
  includeFontPadding: false,  // optional fix for Android text size
},
...
selectedCuisine: {
  ...
  height: 48, // or adjust based on your design
  marginTop: 8,
},
